...
Per maggiori informazioni, vedi: https://www.opencontent.it/Per-la-PA/OpenSegnalazioni

## Documentazione
La documentazione di OpenSegnalazioni è stata realizzata con Readthedocs: https://manuale-opensegnalazioni.readthedocs.io
...
Opencontent SCARL
https://www.opencontent.it/
Opencontent si è occupato della progettazione, realizzazione e manutenzione tecnica di OpenSegnalazioni

## Licenza e modalità d'uso
OpenSegnalazioni è rilasciato con licenza aperta, GNU General Public License v2.0, che puoi leggere integralmente qui: http://www.gnu.org/licenses/gpl-2.0.txt 

Grazie a questa licenza, qualsiasi utente di OpenSegnalazioni gode delle quattro libertà fondamentali:
...
## Codice etico
OpenSegnalazioni è un'applicazione Open Source. Il codice sorgente viene rilasciato con licenza GNU General Public License v2.0 per due ragioni: 
