<div class="row service_teaser">
  ...
  <div class="service_details {if $node|has_attribute('image')}col-sm-8 col-md-8{else}col-sm-12 col-md-12{/if}">      
      <h2 class="section_header skincolored noborder">
        <a href={$node.url_alias|ezurl()} class="dark">{$node.name|wash()|bracket_to_strong}</a>
        <a href={$node.url_alias|ezurl()} class="btn btn-primary btn-lg pull-right"><strong>Clicca qui per partecipare</strong></a>
