            ...
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                ...
                <tr>
                    <td align='center' bgcolor='#f90f00' valign='top'>
                        <h3><a href="http://{ezini( 'SiteSettings', 'SiteURL' )}/sensor/posts/{$object.id}" style="color: #ffffff !important">{"Leggi la segnalazione"|i18n('openpa_sensor/mail/post')}</a></h3>
                    </td>
                </tr>
                <tr>
                    <td align='center' valign='top'>
    ...
    <tr>
        <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                ...
                <tr>
                    <td align='center' bgcolor='#f90f00' valign='top'>
                        <h3><a href="http://{ezini( 'SiteSettings', 'SiteURL' )}/sensor/posts/{$object.id}" style="color: #ffffff !important">{"Vai alla seganalazione"|i18n('openpa_sensor/mail/post')}</a></h3>
                    </td>
                </tr>
                <tr>
                    <td align='center' valign='top'>
